...
with gr.Blocks() as demo:
    gr.Markdown("Voice Crafter voice clone")
    with gr.Row():
    ...
    btn = gr.Button("Run")
    btn.click(fn=tts, inputs=[input_audio, original_transcript_input, new_transcript_input, top_k_input, top_p_input, temperature_input, stop_word_count_input, inverse_offset_input, model_input], outputs=output_audio)
